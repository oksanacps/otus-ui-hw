...
class RegisterPage(BasePage):
    ...
    def input_client_data_to_required_field(self, first_name, last_name, email, password):
    ...
    def check_policy_checkbox(self):
        self.driver.find_element(By.CSS_SELECTOR, '#form-register > div > div > input').click()

    def click_submit_button(self):
        self.driver.find_element(By.CSS_SELECTOR, '#form-register > div > button').click()
